        ...
        <div class="col-12">
            <form action="<?= base_url() ?>index.php/Pais/newPais" method="POST" id="formPais">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label for="txtNacionalidad">Nationality</label>
                ...
                <div class="row mb-3">
                    <div class="col-12">
                        <div class="form-group text-left" id="btnGuardar">
                            <button class="btn btn-outline-success btn-lg" type="submit">Save Country</button>
                        </div>
                        <div class="form-group text-left" style="display: none;" id="btnEditar">
                            <button class="btn btn-outline-primary btn-lg" type="button" onclick="UpdatePais()">Edit Country</button>
                        </div>
                    </div>
                </div>
            </form>
                ...
                <tbody>
                    <?php foreach ($listPaises as $key_pais => $pais): ?>
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-outline-warning btn-lg" type="button" onclick="ChargePais('<?= $pais->ID_Pais ?>', '<?= $pais->Pais ?>', '<?= $pais->Nacionalidad ?>')">Edit</button>
                            </td>
                        </tr>
                    <?php endforeach ?>
                </tbody>
