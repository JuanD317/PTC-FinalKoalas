        ...
        <div class="row mb-3">
          <div class="col-6">
            <div class="form-group">
              <label for="txtCertificaciones">Certification</label>
        ...
        <div class="row mb-3">
          <div class="col-12">
            ...
            <div class="form-group text-left" id="btnEdit" style="display: none;">
              <button class="btn btn-info btn-lg" type="button" onclick="UpdateCertificaciones()">Edit</button>
            </div>
          </div>
        </div>
      </form>
            ...
            <tbody>
              <?php foreach ($listCertificaciones as $key_Certificaciones => $Certificaciones): ?>
                <tr>
                  ...
                  <td>
                    <button class="btn btn-outline-warning btn-lg" type="button" onclick="ChargeCertificaciones('<?= $Certificaciones->ID_Certificacion ?>', '<?= $Certificaciones->Nombre ?>', '<?= $Certificaciones->Descripcion ?>')">Edit</button>
                  </td>
                </tr>
              <?php endforeach ?>
            </tbody>
