        ...
        <div class="row mb-3">
          <div class="col-md-12">
            <div class="form-group">
              <label for="txtTProductos">Product Type</label>
        ...
        <div class="row mb-3">
          <div class="col-12">
            ...
            <div class="form-group text-left" id="btnEdit" style="display: none;">
              <button class="btn btn-outline-info btn-lg" type="button" onclick="UpdateTProductos()">Edit</button>
            </div>
          </div>
        </div>
      </form>
            ...
            <tbody>
              <?php foreach ($listTProductos as $key_TProductos => $TProductos): ?>
                <tr>
                  ...
                  <td>
			        	<button class="btn btn-outline-warning btn-lg" type="button" onclick="ChargeTProductos('<?= $TProductos->ID_TipoProducto ?>','<?= $TProductos->TipoProducto ?>')">Edit</button>
                  </td>
                </tr>
              <?php endforeach ?>
            </tbody>
