        ...
        <div class="row mb-3">
          <div class="col-12">
            ...
            <div class="form-group text-left" id="btnEdit" style="display: none;">
              <button class="btn btn-outline-info btn-lg" type="button" onclick="UpdateSexo()">Edit</button>
            </div>
          </div>
        </div>
      </form>
                ...
                <tr>
                  ...
                  <td>
                  	<div class="row">
                  		<div class="col-md-6">
                  			<div class="form-group">
			                    <button class="btn btn-outline-warning btn-lg" type="button" onclick="ChargeSexo('<?= $Sexo->ID_Sexo ?>','<?= $Sexo->Nombre ?>')">Edit</button>
                  			</div>
                  		</div>
                  		<div class="col-md-6">
                  			<div class="form-group">
			                    <form action="<?= base_url() ?>index.php/Sex/deleteSexo" method="POST">
			                    	...
			                    	<button class="bnt btn-outline-danger btn-lg" type="submit">Remove</button>
			                    </form>
                  			</div>
                  		</div>
                  	</div>
