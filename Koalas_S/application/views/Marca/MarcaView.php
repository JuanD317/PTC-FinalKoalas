        ...
        <div class="row mb-3">
          <div class="col-12">
            ...
            <div class="form-group text-left" id="btnEdit" style="display: none;">
              <button class="btn btn-info btn-lg" type="button" onclick="UpdateMarca()">Edit</button>
            </div>
          </div>
        </div>
      </form>
            ...
            <tbody>
              <?php foreach ($listMarca as $key_Marca => $Marca): ?>
                <tr>
                  <td><?= $Marca->Marca ?></td>
                  <td>
                    <button class="btn btn-outline-warning btn-lg" type="button" onclick="ChargeMarca('<?= $Marca->ID_Marca ?>', '<?= $Marca->Marca ?>')">Edit</button>
                  </td>
                </tr>
              <?php endforeach ?>
            </tbody>
