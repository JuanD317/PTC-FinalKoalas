        ...
        <div class="row mb-3">
          <div class="col-md-12">
            <div class="form-group">
              <label for="txtTMovimientos">Type of kardex movement</label>
        ...
        <div class="row mb-3">
          <div class="col-12">
            ...
            <div class="form-group text-left" id="btnEdit" style="display: none;">
              <button class="btn btn-outline-info btn-lg" type="button" onclick="UpdateTMovimientos()">Edit</button>
            </div>
          </div>
        </div>
      </form>
            ...
            <tbody>
              <?php foreach ($listTMovimientos as $key_TMovimientos => $TMovimientos): ?>
                <tr>
                  ...
                  <td>
			        <button class="btn btn-outline-warning btn-lg" type="button" onclick="ChargeTMovimientos('<?= $TMovimientos->ID_TipoMovimiento ?>','<?= $TMovimientos->Movimiento ?>')">Edit</button>
                  </td>
                </tr>
              <?php endforeach ?>
            </tbody>
