        ...
        <div class="row mb-3">
          <div class="col-md-12">
            <div class="form-group">
              <label for="txtTService">Type of Service</label>
        ...
        <div class="row mb-3">
          <div class="col-12">
            ...
            <div class="form-group text-left" id="btnEdit" style="display: none;">
              <button class="btn btn-outline-info btn-lg" type="button" onclick="UpdateTService()">Edit</button>
            </div>
          </div>
        </div>
      </form>
            ...
            <tbody>
              <?php foreach ($listTService as $key_TService => $TService): ?>
                <tr>
                  ...
                  <td>
			        	<button class="btn btn-outline-warning btn-lg" type="button" onclick="ChargeTService('<?= $TService->ID_TipoServicio ?>','<?= $TService->TipoServicio ?>')">Edit</button>
                  </td>
                </tr>
              <?php endforeach ?>
            </tbody>
