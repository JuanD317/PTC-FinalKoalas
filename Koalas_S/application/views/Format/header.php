...
<body>
  ...
  <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark">
    <a class="navbar-brand" href="http://localhost/Koalas/Koalas_S/index.php/Ecommerce">Koala Care</a>
        ...
        <div class="row text-light">
          <div class="col-md-12">
            ...
            switch ($_SESSION["login"]["Permiso"]) {
              ...
              case 2:
                # Empleado
                echo '<span class="badge badge-pill badge-warning">Employee</span>';
                break;
              case 3:
                # Usuario
                echo '<span class="badge badge-pill badge-success">Client</span>';
                break;
              default:
                # code...
                break;
          ...
          <ul class="second-nav">
            <?php if ($_SESSION["login"]["Permiso"] == 1): ?>              
              <li class="devices">
                ...
                <ul>
                  <li><a href="<?= base_url() ?>index.php/Pais">Countries</a></li>
                  <li><a href="<?= base_url() ?>index.php/Departamento">Departments</a></li>
                  <li><a href="<?= base_url() ?>index.php/Municipio">Municipalities</a></li>
                  <li><a href="<?= base_url() ?>index.php/Sex">Gender</a></li>
                  <li><a href="<?= base_url() ?>index.php/TService">Type Services</a></li>
                  <li><a href="<?= base_url() ?>index.php/TProductos">Types Products</a></li>
                  <li><a href="<?= base_url() ?>index.php/TMovimientos">Types of kardex movements</a></li>
                </ul>
              </li>
            <?php endif ?>
              ...
              <li class="magazines">
                ...
                <ul>
                  <?php if ($_SESSION["login"]["Permiso"] == 1 || $_SESSION["login"]["Permiso"] == 2): ?>
                    <li><a href="<?= base_url() ?>index.php/Customer">Customers</a></li>
                    <li><a href="<?= base_url() ?>index.php/Service">Services</a></li>
                  <?php endif ?>
                  <li><a href="<?= base_url() ?>index.php/Citas">appointments</a></li>
                  <li><a href="<?= base_url() ?>index.php/Pet">Pets</a></li>
                </ul>
              </li>
            <?php endif ?>
            <?php if ($_SESSION["login"]["Permiso"] == 1 || $_SESSION["login"]["Permiso"] == 2): ?>
              <li class="store">
                <a href="#">Employees</a>
                <ul>
                  <li><a href="<?= base_url() ?>index.php/Publication">Publications</a></li>
                  <?php if ($_SESSION["login"]["Permiso"] == 1): ?>
                    <li><a href="<?= base_url() ?>index.php/User">Users</a></li>
                  <?php endif ?>
                  <li><a href="<?= base_url() ?>index.php/Marca">Brands</a></li>
                  <li><a href="<?= base_url() ?>index.php/Certificaciones">Certifications</a></li>
                </ul>
              </li>
            <?php endif ?>
            <?php if ($_SESSION["login"]["Permiso"] == 1 || $_SESSION["login"]["Permiso"] == 2): ?>
              <li class="store">
                <a href="#">Billing</a>
                <ul>
                  <li><a href="<?= base_url() ?>index.php/TFactura">Final consumer</a></li>
                  <li><a href="<?= base_url() ?>index.php/TFactura/Compra">Purchase</a></li>
                  <li><a href="<?= base_url() ?>index.php/TFactura/ReportVenta">Sales Report</a></li>
                  <li><a href="<?= base_url() ?>index.php/TFactura/ReportCompra">Purchase Report</a></li>
                </ul>
              </li>
            <?php endif ?>
            <?php if ($_SESSION["login"]["Permiso"] == 1 || $_SESSION["login"]["Permiso"] == 2): ?>
              <li class="store">
                <a href="#">Accounting</a>
                <ul>
                  <li><a href="<?= base_url() ?>index.php/Precio">Prices</a></li>
                  <li><a href="<?= base_url() ?>index.php/Productos">Products</a></li>
                  <li><a href="<?= base_url() ?>index.php/UnidadesMedidas">Units of measurement</a></li>
